...
if __name__ == "__main__":
    ...
    for step in range(test_iter):
        ...
        if flag == 'Conv_Bwd+doubleBwd':
            ...
            l = list(model.parameters()) + [x_norm,x_pool,x_out]
            dconv_w,dconv_b,dnorm_w,dnorm_b,dlin_w,dlin_b, dx_norm,dx_pool,dx_out   = torch.torch.autograd.grad(celoss,l) 
            ...
            x_conv,x_norm, x_pool,x_lin,output = model(x)  # forward+1stbwd+weight op
