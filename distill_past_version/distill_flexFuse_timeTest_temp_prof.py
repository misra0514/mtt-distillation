...
def main(args):
    ...
    for it in range(0, args.Iteration+1):
        ...
        prof = profile(
            ...
            profile_memory=True,
            with_stack=True,
        ) if mem_profile_enabled else None
        if prof is not None:
            prof.start()
        ...
        if Fuse != bwd_Fuse:
            ...
            # x_conv1,x_norm1, x_pool1,x_conv2,x_norm2, x_pool2,x_conv3,x_norm3, x_pool3, x_lin = split_half_snd_dim([x_conv1,x_norm1, x_pool1,x_conv2,x_norm2, x_pool2,x_conv3,x_norm3, x_pool3, x_lin],fuse_mask_list)
            # dx_norm1,dx_pool1,dx_norm2,dx_pool2,dx_norm3,dx_pool3,x_out,dx_out = split_half_snd_dim([dx_norm1,dx_pool1,dx_norm2,dx_pool2,dx_norm3,dx_pool3,x_out,dx_out], fuse_mask_list)
            ...
            # conv1_w, conv1_b, norm1_w, norm1_b, conv2_w, conv2_b, norm2_w, norm2_b, conv3_w, conv3_b, norm3_w, norm3_b, lin_w = split_half_snd_dim([conv1_w, conv1_b, norm1_w, norm1_b, conv2_w, conv2_b, norm2_w, norm2_b, conv3_w, conv3_b, norm3_w, norm3_b, lin_w], fuse_mask_list)
