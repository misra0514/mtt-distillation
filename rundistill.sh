...
WANDB_SILENT=true python distill_flexFuse_timeTest_temp.py  --fuse_mask_list 0 1 \
   --dataset=CIFAR10 --pix_init=real --ipc=10 \
    --syn_steps=1 --max_experts=1 --expert_epochs=1 --max_start_epoch=1 --Iteration=400 \
    --detachNum=0  \
    --lr_img=1000 --lr_lr=1e-05 --lr_teacher=0.01 \
    --buffer_path=../../mtt-temp/mtt-distillation/buffer --data_path=../../mtt-temp/mtt-distillation/dataset \
    --Fuse=1 \
    --AccTest=True \
