...
# WANDB_SILENT=true python distill_flexFuse_timeTest_ViT.py  --fuse_mask_list 1 1\
...
# WANDB_SILENT=true python distill_batched_timeTest.py   \
# WANDB_SILENT=true python distill_original_timeTest.py  \
# WANDB_SILENT=true python distill_flexFuse_timeTest_conv_backup.py  --fuse_mask_list 1 0 \
WANDB_SILENT=true python distill_flexFuse_timeTest_conv.py  --fuse_mask_list 1 0 \
   --dataset=CIFAR10 --pix_init=real --ipc=10 \
    --syn_steps=1 --max_experts=1 --expert_epochs=1 --max_start_epoch=1 --Iteration=350 \
    --detachNum=0  \
