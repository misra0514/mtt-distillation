...
python distill.py --dataset=CIFAR10 --ipc=10 --syn_steps=20 --expert_epochs=3 \
    --max_start_epoch=20 --zca --lr_img=1000 --lr_lr=1e-05 --lr_teacher=0.01 \
    --trunkSize=7 --eval_mode=TM --detachNum=16 \
    --buffer_path=buffer --data_path=dataset > output_3.txt  

    #  python distill.py --dataset=CIFAR10 --ipc=10 --syn_steps=2 --expert_epochs=3    --max_start_epoch=20 --zca --lr_img=1000 --lr_lr=1e-05 --lr_teacher=0.01    --eval_mode=M --buffer_path=buffer --data_path=dataset > output_2.txt  
